 ...
 * @example
 *
 * @param {Object} credentials object with params
 * @param {string} credentials.TOKEN Cucumber Studio API token
 * @param {string} credentials.CLIENT Cucumber Studio identifier
 * @param {string} credentials.UID User email of CucumberStudio Account
 * @param {string} [credentials.projectId] project ID to work with
 * @param {Object} [opts] object with params
 * @param {string} [opts.requestOptions] some request options for request-promise-native
 * @param {string} [opts.proxy] proxy settings
 *
 */
class CucumberStudio {
  constructor(
    ...
    this.request = request.defaults(reqOptions);
  }
   ...
   * @param {Object} $0 object with params
   * @param {number | string} [$0.projectId=this.projectId] project ID
   * @param {number | string} $0.scenarioId scenario ID
